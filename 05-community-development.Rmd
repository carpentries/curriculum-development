...
help overcome authors' [expert blind spot][expert-blind-spot]. 
...
and as a [video recording][maintainer-onboarding-video], however, if 
...
During the workshop, pilot instructors should take detailed notes, including:  
...
as it will add significantly to their cognitive load. 

After the workshop, instructors should share the notes document with the lesson authors - who 
will convert the notes into individual issues in the lesson repo. Lesson authors should expect
to spend at least four hours to create follow-up issues for each pilot workshop, and at least
eight hours to putting in PRs to fix these issues. For two beta pilot workshops, this translates
...
[expert-blind-spot]: https://carpentries.github.io/instructor-training/03-expertise/
...
[maintainer-onboarding-video]: link
