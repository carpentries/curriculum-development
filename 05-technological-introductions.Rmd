...
* [carpentrieslab](http://github.com/carpentrieslab) - hosts lessons in development which may or may not become part of the official Carpentries lesson stack




Your lesson files will be publically hosted on GitHub, within the [data-lessons](https://github.com/data-lessons) or
[carpentrieslab](https://github.com/carpentrieslab) organization. Lessons that are intended to be offered as 
core Carpentries lessons will be hosted in data-lessons, while more informal lessons that use The Carpentries
template and pedagogical model, but are not intended for broad teaching will be hosted in carpentrieslab. When
a lesson has fulfilled the requirements to be a core Carpentries lesson, it will be migrated to the appropriate
GitHub organization for that Lesson Program (e.g. [datacarpentry](https://github.com/datacarpentry)). 
Lessons developed in data-lessons or carpentrieslab can both become core Carpentries lessons, however 
these organizations carry different expectations for level of community and staff support. 



In order to contribute to lesson materials, you will need a GitHub ID. 
